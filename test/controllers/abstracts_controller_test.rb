...
class AbstractsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create abstract" do
    assert_difference("Abstract.count") do
      post abstracts_url, params: { abstract: { description: @abstract.description, topic_name: @abstract.topic_name } }
    end
  ...
  test "should update abstract" do
    patch abstract_url(@abstract), params: { abstract: { description: @abstract.description, topic_name: @abstract.topic_name } }
